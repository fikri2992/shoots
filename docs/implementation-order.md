...
| 2 | complete | Build longitudinal evidence | Rebuildable Technique Map, Tendency Profile, Change, and Journey projections | Recurrence, distinct Shoot coverage, result-Shot outcomes, settled/evaluable/Criteria-met Reproduce sessions, abstentions, and Keeper signals stay separate; no skill score |
...
| 6 | complete | Leave something the Photographer can use or share | Shoot receipt, Journey comparison, and evidence-bound Shoot or terminal-Experiment Deconstruction | Artifacts cite stored Evidence, label model reads, preserve uncertainty, require a Photographer-owned cover, and never auto-post |
