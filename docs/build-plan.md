...
- This Day 15 pass changed documentation only. Later continuation work built persisted Scene/Shoot lifecycle, Shoot synthesis, typed Scout routing, scoped memory, source authority, corrected Explore, and the first evidence-bound Deconstruction. The feature list is current.
