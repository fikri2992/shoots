...
This is the executable recording plan. [Submission proof](submission-proof.md)
remains the claim ledger and final capture checklist.
...
**Tone contract:** personal, quiet, and exact. The Photographer is the protagonist;
the system is competent background labor. Never make a model response the climax.

**Opening result:** show one settled Shoot receipt for two seconds before explaining
...
- Hide email, tokens, OAuth screens, personal media outside the demo set, local paths,
  and unrelated Cloud projects.
- Clear notifications and browser history suggestions before capture.

## Four-minute paper edit
...
- I cannot distinguish deliberate Technique from luck, **therefore** Phone Source
  observes ordinary work.
- One Shot cannot prove recurrence, **therefore** Runs settle into a Shoot Record.
- A model opinion cannot own the Photographer's taste, **therefore** claims retain
  Evidence class and the Photographer owns Keeper and Intent.
- Memory alone can become repetitive advice, **therefore** Scout stores warrants,
  rejected routes, and observable outcomes.
- Advice without evaluation is decoration, **therefore** Experiments leave typed
  records and later routing may change.

Any beat connected only by “and then” is cut from the video.
...
Fill these only from the accepted recording run:
